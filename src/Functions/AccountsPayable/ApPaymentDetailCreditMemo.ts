...
export default class ApPaymentDetailCreditMemo implements IApPaymentDetail {
    private readonly info: ApPaymentDetailInfo;

    constructor(info: ApPaymentDetailInfo) {
        this.info = info;
    }
