...
import AndCondition from "../../../../../src/Functions/Common/Query/Logical/AndCondition";
...
describe("AndCondition", () => {
    ...
    it("should construct to string", () => {
        ...
        chai.assert.equal(and.toString(), "(VENDORID = 'V1234' AND STATUS = 'T')");
    });
    it("should allow setter to string", () => {
        ...
        chai.assert.equal(and.toString(), "NOT (VENDORID = 'V1234' AND STATUS = 'T')");
    });
});
