...
import GreaterThanOrEqualToNumber from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThanOrEqualTo/GreaterThanOrEqualToNumber";

describe("GreaterThanOrEqualToNumber", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanOrEqualToNumber();
