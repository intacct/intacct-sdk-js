...
import GreaterThanOrEqualToDate from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThanOrEqualTo/GreaterThanOrEqualToDate";
...
describe("GreaterThanOrEqualToDate", () => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanOrEqualToDate();
