...
import GreaterThanOrEqualToInteger from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThanOrEqualTo/GreaterThanOrEqualToInteger";

describe("GreaterThanOrEqualToInteger", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanOrEqualToInteger();
