...
import GreaterThanOrEqualToString from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThanOrEqualTo/GreaterThanOrEqualToString";

describe("GreaterThanOrEqualToString", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanOrEqualToString();
