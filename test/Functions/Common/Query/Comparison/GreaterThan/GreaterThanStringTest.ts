...
import GreaterThanString from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThan/GreaterThanString";

describe("GreaterThanString", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanString();
