...
import GreaterThanInteger from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThan/GreaterThanInteger";

describe("GreaterThanInteger", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanInteger();
