...
import GreaterThanDateTime from "../../../../../../src/Functions/Common/Query/Comparison/GreaterThan/GreaterThanDateTime";

describe("GreaterThanDateTime", () => {
    before((done) => {
        return done();
    });
    beforeEach((done) => {
    ...
    it("output the condition to a string", () => {
        const condition = new GreaterThanDateTime();
