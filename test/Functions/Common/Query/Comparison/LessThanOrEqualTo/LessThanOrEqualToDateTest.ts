...
import LessThanOrEqualToDate from "../../../../../../src/Functions/Common/Query/Comparison/LessThanOrEqualTo/LessThanOrEqualToDate";
...
describe("LessThanOrEqualToDate", () => {
    ...
    it("output the condition to a string", () => {
        const condition = new LessThanOrEqualToDate();
