...
import ApPaymentCreate from "../../../src/Functions/AccountsPayable/ApPaymentCreate";
...
<test>
    <function controlid="unittest">
        ...
        info.paymentDate = new Date("10/06/2020");
...
<test>
    <function controlid="unittest">
        ...
        info.paymentDate = new Date("06/30/2015");
        info.exchangeRateDate = new Date("06/30/2015");
