...
import CustomerUpdate from "../../../src/Functions/AccountsReceivable/CustomerUpdate";
...
describe("CustomerUpdate", () => {
    ...
    it("should update Customer with minimal parameters", () => {
...
<test>
    <function controlid="unittest">
        ...
        const record = new CustomerUpdate();
        record.controlId = "unittest";
        record.customerId = "C1234";

        XmlObjectTestHelper.CompareXml(expected, record);
    });
    it("should update Customer with all parameters", () => {
        const expected = `<?xml version="1.0" encoding="utf-8" ?>
<test>
    <function controlid="unittest">
        <update>
        ...
        record.customFields = [["CUSTOMFIELD1", "Hello"]];
