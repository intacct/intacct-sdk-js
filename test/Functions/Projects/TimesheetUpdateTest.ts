...
<test>
    <function controlid="unittest">
        ...
        const entry = new TimesheetEntryUpdate();
        entry.lineRecordNo = 1;
        entry.quantity = 5;
...
<test>
    <function controlid="unittest">
        ...
        const record = new TimesheetUpdate();
        record.controlId = "unittest";
        const entry1 = new TimesheetEntryUpdate();
        entry1.lineRecordNo = 1;
        entry1.quantity = 5;
        entry1.entryDate = new Date("06/30/2016");
        const entry2 = new TimesheetEntryUpdate();
        entry2.lineRecordNo = 2;
        entry2.quantity = 6;
